...
class FireDepartmentsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $fireDepartments = [
            ...
            // 長崎県
            ['name' => '長崎市消防局', 'prefecture_id' => 42],
            ['name' => '佐世保市消防局', 'prefecture_id' => 42],
            ['name' => '平戸市消防本部', 'prefecture_id' => 42],
            ['name' => '松浦市消防本部', 'prefecture_id' => 42],
            ['name' => '壱岐市消防本部', 'prefecture_id' => 42],
            ['name' => '対馬市消防本部', 'prefecture_id' => 42],
            ['name' => '五島市消防本部', 'prefecture_id' => 42],
            ['name' => '新上五島町消防本部', 'prefecture_id' => 42],
            ['name' => '県央地域広域市町村圏組合消防本部', 'prefecture_id' => 42],
            ['name' => '島原地域広域市町村圏組合消防本部', 'prefecture_id' => 42],
            // 熊本県
            ['name' => '熊本市消防局', 'prefecture_id' => 43],
            ['name' => '山鹿市消防本部', 'prefecture_id' => 43],
            ['name' => '宇城広域連合消防本部', 'prefecture_id' => 43],
            ['name' => '人吉下球磨消防組合消防本部', 'prefecture_id' => 43],
            ['name' => '上益城消防組合消防本部', 'prefecture_id' => 43],
            ['name' => '上球磨消防組合消防本部', 'prefecture_id' => 43],
            ['name' => '八代広域行政事務組合消防本部', 'prefecture_id' => 43],
            ['name' => '阿蘇広域行政事務組合消防本部', 'prefecture_id' => 43],
            ['name' => '有明広域行政事務組合消防本部', 'prefecture_id' => 43],
            ['name' => '水俣芦北広域行政事務組合消防本部', 'prefecture_id' => 43],
            ['name' => '菊池広域連合消防本部', 'prefecture_id' => 43],
            ['name' => '天草広域連合消防本部', 'prefecture_id' => 43],
            // 大分県
            ['name' => '大分市消防局', 'prefecture_id' => 44],
            ['name' => '別府市消防本部', 'prefecture_id' => 44],
            ['name' => '中津市消防本部', 'prefecture_id' => 44],
            ['name' => '日田玖珠広域消防組合消防本部', 'prefecture_id' => 44],
            ['name' => '佐伯市消防本部', 'prefecture_id' => 44],
            ['name' => '臼杵市消防本部', 'prefecture_id' => 44],
            ['name' => '津久見市消防本部', 'prefecture_id' => 44],
            ['name' => '竹田市消防本部', 'prefecture_id' => 44],
            ['name' => '豊後高田市消防本部', 'prefecture_id' => 44],
            ['name' => '杵築速見消防組合消防本部', 'prefecture_id' => 44],
            ['name' => '宇佐市消防本部', 'prefecture_id' => 44],
            ['name' => '豊後大野市消防本部', 'prefecture_id' => 44],
            ['name' => '由布市消防本部', 'prefecture_id' => 44],
            ['name' => '国東市消防本部', 'prefecture_id' => 44],
            // 宮崎県
            ['name' => '宮崎市消防局', 'prefecture_id' => 45],
            ['name' => '都城市消防局', 'prefecture_id' => 45],
            ['name' => '延岡市消防本部', 'prefecture_id' => 45],
            ['name' => '日南市消防本部', 'prefecture_id' => 45],
            ['name' => '日向市消防本部', 'prefecture_id' => 45],
            ['name' => '串間市消防本部', 'prefecture_id' => 45],
            ['name' => '西都市消防本部', 'prefecture_id' => 45],
            ['name' => '宮崎県東児湯消防組合消防本部', 'prefecture_id' => 45],
            ['name' => '西諸広域行政事務組合消防本部', 'prefecture_id' => 45],
            ['name' => '西臼杵広域行政事務組合消防本部', 'prefecture_id' => 45],
            // 鹿児島県
            ['name' => '鹿児島市消防局', 'prefecture_id' => 46],
            ['name' => '出水市消防本部', 'prefecture_id' => 46],
            ['name' => '垂水市消防本部', 'prefecture_id' => 46],
            ['name' => '薩摩川内市消防局', 'prefecture_id' => 46],
            ['name' => '日置市消防本部', 'prefecture_id' => 46],
            ['name' => '霧島市消防局', 'prefecture_id' => 46],
            ['name' => 'いちき串木野市消防本部', 'prefecture_id' => 46],
            ['name' => '枕崎市消防本部', 'prefecture_id' => 46],
            ['name' => '南さつま市消防本部', 'prefecture_id' => 46],
            ['name' => 'さつま町消防本部', 'prefecture_id' => 46],
            ['name' => '指宿南九州消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '姶良市消防本部', 'prefecture_id' => 46],
            ['name' => '阿久根地区消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '伊佐湧水消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '大隅曽於地区消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '大隅肝属地区消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '沖永良部与論広域事務組合消防本部', 'prefecture_id' => 46],
            ['name' => '徳之島地区消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '熊毛地区消防組合消防本部', 'prefecture_id' => 46],
            ['name' => '大島地区消防組合消防本部', 'prefecture_id' => 46],
            // 沖縄県
            ['name' => '那覇市消防局', 'prefecture_id' => 47],
            ['name' => '宜野湾市消防本部', 'prefecture_id' => 47],
            ['name' => '石垣市消防本部', 'prefecture_id' => 47],
            ['name' => '浦添市消防本部', 'prefecture_id' => 47],
            ['name' => '名護市消防本部', 'prefecture_id' => 47],
            ['name' => '糸満市消防本部', 'prefecture_id' => 47],
            ['name' => '沖縄市消防本部', 'prefecture_id' => 47],
            ['name' => '豊見城市消防本部', 'prefecture_id' => 47],
            ['name' => 'うるま市消防本部', 'prefecture_id' => 47],
            ['name' => '宮古島市消防本部', 'prefecture_id' => 47],
            ['name' => '島尻消防組合消防本部', 'prefecture_id' => 47],
            ['name' => '久米島町消防本部', 'prefecture_id' => 47],
            ['name' => '本部町今帰仁村消防組合消防本部', 'prefecture_id' => 47],
            ['name' => '東部消防組合消防本部', 'prefecture_id' => 47],
            ['name' => '中城北中城消防組合消防本部', 'prefecture_id' => 47],
            ['name' => '金武地区消防衛生組合消防本部', 'prefecture_id' => 47],
            ['name' => '国頭地区行政事務組合消防本部', 'prefecture_id' => 47],
            ['name' => '比謝川行政事務組合ニライ消防本部', 'prefecture_id' => 47]
        ];
